...
impl<'a, K: Hash + Eq, V: Clone, A: Allocator> LockedHashMap<'a, K, V, A> {
...
impl<'a, K: Hash + Eq, V: Clone, A: Allocator> ConcurrentHashMap<'a, K, V, A> {
...
impl<'a, K: Hash + Eq, V, A: Allocator> ShardMapBox<'a, K, V, A> {
